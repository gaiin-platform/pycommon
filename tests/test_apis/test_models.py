...
class TestGetDefaultModels:
    ...
    @patch.dict(os.environ, {"API_BASE_URL": "https://api.example.com"})
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_response_not_success(self, mock_logger, mock_get):
        ...
        mock_logger.error.assert_called_once_with(
            "Missing data in default models response"
        )

    @patch.dict(os.environ, {"API_BASE_URL": "https://api.example.com"})
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_missing_data_field(self, mock_logger, mock_get):
    ...
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_empty_response(self, mock_logger, mock_get):
    ...
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_none_response(self, mock_logger, mock_get):
    ...
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_missing_user_model(self, mock_logger, mock_get):
        ...
        assert result == {}
        mock_logger.error.assert_called_once_with("Missing default model")

    @patch.dict(os.environ, {"API_BASE_URL": "https://api.example.com"})
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_empty_user_model(self, mock_logger, mock_get):
    ...
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_none_user_model(self, mock_logger, mock_get):
    ...
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_http_error(self, mock_logger, mock_get):
    ...
    @patch("pycommon.api.models.requests.get")
    @patch("pycommon.api.models.logger")
    def test_get_default_models_request_exception(self, mock_logger, mock_get):
