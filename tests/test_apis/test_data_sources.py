...
from api.object_permissions import can_access_objects
...
@patch("api.data_sources.boto3.client")
...
@patch("api.data_sources.translate_user_data_sources_to_hash_data_sources")
...
def test_get_data_source_keys_no_key_field():
    ...
    with patch(
        "api.data_sources.translate_user_data_sources_to_hash_data_sources"
    ) as mock_translate:
